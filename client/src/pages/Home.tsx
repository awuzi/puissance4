          ...
          <div className="flex flex-col items-center pb-10">
            <img src="/assets/logo.png" alt="Logo" width={200} height={200} />
              ...
              <div className="flex flex-col mt-4 space-x-3 md:mt-6">
                <button onClick={createGame} className="py-2 px-4 ml-3 mr-3 text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                  Créer une partie
                </button>
